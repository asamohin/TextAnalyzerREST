...
public class ParserJSON {
    private static final Logger log = LoggerFactory.getLogger(ParserJSON.class.getName()); 
        ...
        public static void main(String[] args) throws Exception {
           ...
           /*
            ...
            for (int i = 0; i < list.length; i++) {
                log.info(list[i].toString().contains(""));
            }
            ...
            */
            ...
            while (phonesItr.hasNext()) {
                ...
                log.info("- type: " + test.get("type") + ", phone: " + test.get("number"));
            }
            }
             */